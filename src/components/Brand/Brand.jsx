    ...
    <section className="brand">
      <div className="brand__left">
        ...
        <p className="brand__subtitle">
          Каждый фургон проходит строгий контроль качества, что обеспечивает его надежность и
          долговечность. Мы уверены в каждом нашем изделии и стремимся предложить вам только лучшее.
        </p>
      </div>
